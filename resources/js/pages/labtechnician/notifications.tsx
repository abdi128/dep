...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Lab Technician Dashboard', href: '/labtechnician/dashboard' },
];

export default function LabTechnicianNotifications({ incoming, read }) {
  ...
  function handleMarkAsRead(notification) {
    router.post(
      route('labtechnician.notifications.read', { notification: notification.id }),
      {},
      {
        preserveScroll: true,
